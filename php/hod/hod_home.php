...
<html lang="en">
   ...
   <body>
      <div class="side_panel">
         ...
         <div class="sidebar">
            <ul>
               <li><a href="http://localhost/whiteboard/php/hod/hod_home.php" class="active">Home</a></li>
               ...
               <li><a href="http://localhost/whiteboard/php/hod/hod_time_table.php">Time Table Commitee</a></li>
                 <li><a href="http://localhost/whiteboard/php/hod/hod_class_coordinator.php">Class Coordinator</a></li>
